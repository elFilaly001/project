  ...
  <div className="bg-gradient-to-r from-[#F02CB9] to-[#35B9F4] text-white rounded-lg p-8 md:p-12 mb-8 shadow-md">
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-4 flex gap-2 flex-wrap text-sm">
            <span className="px-3 py-1 bg-white/10 text-white rounded-full">Forms</span>
            <span className="px-3 py-1 bg-white/10 text-white rounded-full">Templates</span>
            <span className="px-3 py-1 bg-white/10 text-white rounded-full">Rules</span>
            <span className="px-3 py-1 bg-white/10 text-white rounded-full">Export</span>
            <span className="px-3 py-1 bg-white/10 text-white rounded-full">Billing</span>
          </div>
        </div>
      </div>
