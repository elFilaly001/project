...
export default function KickPostCard({
  username,
  userAvatar,
  postDate,
  postImage,
  ...
  return (
    <div className="bg-white rounded-xl p-4 shadow-sm border w-full max-w-xs">
      <div className="flex items-center justify-between mb-2">
        ...
        {/* Right group: Kick icon + label + postUrl icon */}
        <div className="flex items-center gap-2">
          <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/kick.svg" alt="Kick" className="w-5 h-5" />
