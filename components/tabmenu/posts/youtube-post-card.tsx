...
import { FaYoutube, FaRegHeart, FaRegComment, FaRegEye } from "react-icons/fa";
  ...
  return (
    <div className="bg-white rounded-xl p-4 shadow-sm border w-full max-w-xs">
      <div className="flex items-center justify-between mb-2">
        ...
        {/* Right group: YouTube icon + Video label + postUrl icon */}
        <div className="flex items-center gap-2">
      ...
      <div className="rounded-lg overflow-hidden mb-3 bg-black flex items-center justify-center" style={{ aspectRatio: "1 / 1" }}>
        <img
          src={postImage}
          alt="YouTube post"
